...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "  Option 2 (JAR):"
    echo "  java -jar target/ibm-mq-simulator-1.0.0.jar"
    echo ""
    echo "Note: Make sure you have IBM MQ server running and configured"
    echo "      as specified in src/main/resources/application.properties"
    echo ""
else
    echo ""
